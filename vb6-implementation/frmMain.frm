...
Begin VB.MDIForm frmMain 
   ...
   Begin VB.Menu mnuBuild 
      Caption         =   "&»‰«¡"
      Begin VB.Menu mnuLexer 
         Caption         =   "Lexer"
      End
      Begin VB.Menu mnuParser 
         Caption         =   "Parser"
      End
      Begin VB.Menu mnuTranslator 
         Caption         =   "Translator"
      End
   End
...
Private Sub LoadNewDoc()
    ...
    frmD.Caption = "«·»—‰«„Ã " & lDocumentCount
    frmD.RightToLeft = True
    frmD.Show
...
Private Sub mnuLexer_Click()
source = ActiveForm.rtfText.Text
Lexer
End Sub

Private Sub mnuParser_Click()
Parser
End Sub
